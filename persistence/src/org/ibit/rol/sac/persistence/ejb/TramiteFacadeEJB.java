...
public abstract class TramiteFacadeEJB extends HibernateEJB implements
    ...
    /**
     * Autoriza la creaciï¿½n de un trï¿½mite
    ...
    /**
     * Autoriza la modificaciï¿½n trï¿½mite
     * @ejb.interface-method
     * @ejb.permission role-name="${role.system},${role.admin},${role.super},${role.oper}"
     */
	...
	/*    *//**
	 * Aï¿½ade un nuevo formulario al tramite ejb.interface-method
	 * ejb.permission
	 * role-name="${role.system},${role.admin},${role.super},${role.oper}"
	 */
	/*
	 ...
	 * SecurityException("No tiene acceso al trï¿½mite"); } Tramite tramite =
	...
	public void actualizarOrdenDocs(Map<String, String[]> map, long tid)
		...
		try {
			...
			// 3. eliminar documents del trï¿½mit del cache perquï¿½ es recarreguin les llistes de formularis i docsinformatius amb el nou ordre.
	...
	// es fa publica pq tï¿½ que se accedida desde procedimentFacadeEJB
