     ...
     *<form name="procedimientoForm" method="post" action="/sacbackold/contenido/procedimiento/editar.do" id="procedimientoForm"> 
       ...
       <div id="capes"> 
        <div id="capa0" class="capa"> 
            <div class="pestanyes"> 
                    <div class="tab">Catal�n</div> 
                    <div class="notab"><a href="javascript:activarCapa(1, 4)" class="notabb">Castellano</a></div> 
                    <div class="notab"><a href="javascript:activarCapa(2, 4)" class="notabb">Ingl�s</a></div> 
                    <div class="notab"><a href="javascript:activarCapa(3, 4)" class="notabb">Alem�n</a></div> 
            </div> 
            <div class="bloc"> 
                <div class="component"> 
        ...
        <div id="capa1" class="capa"> 
            <div class="pestanyes"> 
                    <div class="notab"><a href="javascript:activarCapa(0, 4)" class="notabb">Catal�n</a></div> 
