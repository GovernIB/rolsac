...
public class ClientVentanillaUnicaTest extends junit.framework.TestCase {
	...
	public void _test01GenerarTramitVudsSenseDocuments() throws IOException {
		...
		_("test amb 1 taxa");
		t=daoTest.creaTramite("tramit test "+new Date(),1,0,0);
		t.setId(12345L);
		...
		_("\ntest amb 2 taxes");
		t=daoTest.creaTramite("tramit test "+new Date(),2,0,0);
		t.setId(12345L);
