...
AbstractTransactionalSpringContextTests {
	...
	public void _testConsultarProcedimientoConTramites()  {
		...
		_(t);
		assertEquals(t.getNombre(),"Sol.licitud de canvi de grup d'ag�ncia de viatges");
...
*/
	...
	public void _testI16_AfegirIEsborrarTramitUltim() throws DelegateException {
		...
		procBean.anyadirTramite(tid, pid);  //a�ade el tramite en un proc. temporal. Ull! p no se modifica.
