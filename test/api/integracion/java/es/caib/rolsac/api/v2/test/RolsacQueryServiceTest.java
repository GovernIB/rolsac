...
public class RolsacQueryServiceTest {
    ...
    public void recuperarTramits() {
        TramitCriteria tramitCriteria = new TramitCriteria();
        tramitCriteria.setT_nombre("%sol穕icitud%");
        ...
        for (TramitQueryServiceAdapter t: tramits) {
            Assert.assertTrue(t.getNombre().toLowerCase().contains("sol穕icitud"));
        }
    }
...
//        docCriteria.setT_titulo("%decret%");
    ...
    public void recuperarUnTipusNormativa() {
        ...
        Assert.assertTrue(tn.getNombre().equals("Resoluci贸"));
    }
    ...
    /**
     * Cas d'us: Recupera una excepci贸 d'aportaci贸 de documentaci贸
     */
    @Test
    ...
    /**
     * Cas d'us: Recuperar una iniciaci贸
     */
    @Test
