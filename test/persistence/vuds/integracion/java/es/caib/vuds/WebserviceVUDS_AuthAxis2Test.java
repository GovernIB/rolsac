...
import es.map.vuds.si.service.webservice.CargarIdiomas;
import es.map.vuds.si.service.webservice.CargarIdiomasE;
import es.map.vuds.si.service.webservice.CargarIdiomasResponse;
import es.map.vuds.si.service.webservice.CargarIdiomasResponseE;
...
import es.map.vuds.si.service.webservice.TramiteVuds;
    ...
    public class WebserviceVUDS_Axis2Test extends junit.framework.TestCase{
    	...
    	GestorWebserviceBeanServiceStub service;
		Idioma idioma;
    	...
    	protected void setUp() throws Exception {
    		super.setUp();
    		service = new GestorWebserviceBeanServiceStub(endpoint);
    		...
    		idioma=new Idioma();
    		idioma.setIdIdioma("es_ES");
    		idioma.setDescripcionIdioma("Castellano");
...
de_DE Deutsch
    	 ...
    	 */
       	public void test01CargarIdiomas() throws MalformedURLException, ServiceException, RemoteException {
       		_(getName());
       		CargarIdiomas ci=new CargarIdiomas();
       		CargarIdiomasE ciE = new es.map.vuds.si.service.webservice.CargarIdiomasE();
       		ciE.setCargarIdiomas(ci);
       		CargarIdiomasResponseE respE= service.cargarIdiomas(ciE);
       		CargarIdiomasResponse  resp = respE.getCargarIdiomasResponse();
       		Idioma[] idiomas = resp.get_return();
       		for(Idioma i:idiomas) {_(i.getIdIdioma()+" "+ i.getDescripcionIdioma()); }

       	}
       	
       	//OK
    	public void _test02CargaCodigosVuds() throws MalformedURLException, ServiceException, RemoteException, FileNotFoundException {
...
0101210002	No se permite la carga dicho idioma en el sistema si no se ha realizado la carga en el idioma por defecto(Español).
    	...
    	public void test03GuardarTramite() throws MalformedURLException, ServiceException, RemoteException {
       		_(getName());
...
Ambas (Interesado y de oficio)
    	 ...
    	 */
    	//OK 26gen2010
       	public void _test04CargarFormasIniciacion() throws MalformedURLException, ServiceException, RemoteException {
       	...
       	public void _test06CargarCanalesTramitacion() throws MalformedURLException, ServiceException, RemoteException {
