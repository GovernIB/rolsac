      ...
      <div class="bloc">
        ...
        <p>
          ...
          <html:form action="/searchnormativa.do">N. Boletin:
            <html:text property="numeroboletin" onchange="ValidaNumero(this)" size="10"/>N. Registro:
            <html:text property="numeroregistro" onchange="ValidaNumero(this)" size="10"/>N. fecha:
