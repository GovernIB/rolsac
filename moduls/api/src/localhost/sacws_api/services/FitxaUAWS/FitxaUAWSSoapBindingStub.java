...
public class FitxaUAWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.FitxaUAWS.FitxaUAQueryServiceEJBRemote {
    ...
    public FitxaUAWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public FitxaUAWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public FitxaUAWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public es.caib.rolsac.api.v2.unitatAdministrativa.UnitatAdministrativaDTO obtenirUnitatAdministrativa(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.fitxaUA.v2.api.rolsac.caib.es", "obtenirUnitatAdministrativa"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.fitxa.FitxaDTO obtenirFitxa(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.fitxaUA.v2.api.rolsac.caib.es", "obtenirFitxa"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.seccio.SeccioDTO obtenirSeccio(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.fitxaUA.v2.api.rolsac.caib.es", "obtenirSeccio"));
