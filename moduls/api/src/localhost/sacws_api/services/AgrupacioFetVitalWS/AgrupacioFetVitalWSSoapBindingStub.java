/**
 * AgrupacioFetVitalWSSoapBindingStub.java
 *
...
public class AgrupacioFetVitalWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.AgrupacioFetVitalWS.AgrupacioFetVitalQueryServiceEJBRemote {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://fetVital.v2.api.rolsac.caib.es", "FetVitalCriteria"), es.caib.rolsac.api.v2.fetVital.FetVitalCriteria.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("https://localhost:8443/sacws-api/services/AgrupacioFetVitalWS", "ArrayOf_xsd_anyType"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getNumFetsVitals");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        oper.setReturnClass(int.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getNumFetsVitalsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[5] = oper;
    ...
    public AgrupacioFetVitalWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AgrupacioFetVitalWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AgrupacioFetVitalWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("https://localhost:8443/sacws-api/services/AgrupacioFetVitalWS", "ArrayOf_xsd_anyType");
            cachedSerQNames.add(qName);
    ...
    public java.lang.Object[] llistarFetsVitals(long in0, es.caib.rolsac.api.v2.fetVital.FetVitalCriteria in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "llistarFetsVitals"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0), in1});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.publicObjectiu.PublicObjectiuDTO obtenirPublicObjectiu(long in0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "obtenirPublicObjectiu"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO getFotografia(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "getFotografia"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO getIcona(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "getIcona"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO getIconaGran(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "getIconaGran"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public int getNumFetsVitals(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.agrupacioFetVital.v2.api.rolsac.caib.es", "getNumFetsVitals"));
