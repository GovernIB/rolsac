/**
 * FormulariWSSoapBindingStub.java
 *
...
public class FormulariWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.FormulariWS.FormulariQueryServiceEJBRemote {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "obtenirArchivoReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenirManual");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://arxiu.v2.api.rolsac.caib.es", "ArxiuDTO"));
        oper.setReturnClass(es.caib.rolsac.api.v2.arxiu.ArxiuDTO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "obtenirManualReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public FormulariWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public FormulariWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public FormulariWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public es.caib.rolsac.api.v2.tramit.TramitDTO obtenirTramit(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.formulari.v2.api.rolsac.caib.es", "obtenirTramit"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO obtenirArchivo(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.formulari.v2.api.rolsac.caib.es", "obtenirArchivo"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO obtenirManual(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.formulari.v2.api.rolsac.caib.es", "obtenirManual"));
