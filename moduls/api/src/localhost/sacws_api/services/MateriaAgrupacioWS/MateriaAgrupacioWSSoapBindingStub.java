/**
 * MateriaAgrupacioWSSoapBindingStub.java
 *
...
public class MateriaAgrupacioWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.MateriaAgrupacioWS.MateriaAgrupacioQueryServiceEJBRemote {
    ...
    public MateriaAgrupacioWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public MateriaAgrupacioWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public MateriaAgrupacioWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public es.caib.rolsac.api.v2.materia.MateriaDTO obtenirMateria(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.materiaAgrupacio.v2.api.rolsac.caib.es", "obtenirMateria"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.agrupacioMateria.AgrupacioMateriaDTO obtenirAgrupacioMateria(long in0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.materiaAgrupacio.v2.api.rolsac.caib.es", "obtenirAgrupacioMateria"));
