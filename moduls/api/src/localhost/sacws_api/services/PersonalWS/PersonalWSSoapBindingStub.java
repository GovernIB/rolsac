...
public class PersonalWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.PersonalWS.PersonalQueryServiceEJBRemote {
    ...
    public es.caib.rolsac.api.v2.unitatAdministrativa.UnitatAdministrativaDTO obtenirUnitatAdministrativa(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.personal.v2.api.rolsac.caib.es", "obtenirUnitatAdministrativa"));
