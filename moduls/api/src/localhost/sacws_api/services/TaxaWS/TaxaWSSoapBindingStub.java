...
public class TaxaWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.TaxaWS.TaxaQueryServiceEJBRemote {
    ...
    public TaxaWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public TaxaWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public TaxaWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public es.caib.rolsac.api.v2.tramit.TramitDTO obtenirTramit(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.taxa.v2.api.rolsac.caib.es", "obtenirTramit"));
