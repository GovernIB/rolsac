...
public class EdificiWSSoapBindingStub extends org.apache.axis.client.Stub implements localhost.sacws_api.services.EdificiWS.EdificiQueryServiceEJBRemote {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("https://localhost:8443/sacws-api/services/EdificiWS", "ArrayOf_xsd_anyType"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenirFotoPequenya");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "obtenirFotoPequenyaReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenirFotoGrande");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://arxiu.v2.api.rolsac.caib.es", "ArxiuDTO"));
        oper.setReturnClass(es.caib.rolsac.api.v2.arxiu.ArxiuDTO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "obtenirFotoGrandeReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[3] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenirPlano");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://arxiu.v2.api.rolsac.caib.es", "ArxiuDTO"));
        oper.setReturnClass(es.caib.rolsac.api.v2.arxiu.ArxiuDTO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "obtenirPlanoReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[4] = oper;
    ...
    public EdificiWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public EdificiWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public EdificiWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("https://localhost:8443/sacws-api/services/EdificiWS", "ArrayOf_xsd_anyType");
            cachedSerQNames.add(qName);
    ...
    public int getNumUnitatsAdministratives(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.edifici.v2.api.rolsac.caib.es", "getNumUnitatsAdministratives"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public java.lang.Object[] llistarUnitatsAdministratives(long in0, es.caib.rolsac.api.v2.unitatAdministrativa.UnitatAdministrativaCriteria in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.edifici.v2.api.rolsac.caib.es", "llistarUnitatsAdministratives"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0), in1});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO obtenirFotoPequenya(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.edifici.v2.api.rolsac.caib.es", "obtenirFotoPequenya"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO obtenirFotoGrande(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.edifici.v2.api.rolsac.caib.es", "obtenirFotoGrande"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public es.caib.rolsac.api.v2.arxiu.ArxiuDTO obtenirPlano(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.edifici.v2.api.rolsac.caib.es", "obtenirPlano"));
