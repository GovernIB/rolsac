...
public class PerfilCriteria  extends es.caib.rolsac.api.v2.general.BasicCriteria  implements java.io.Serializable {
    ...
    private es.caib.rolsac.api.v2.perfil.PerfilOrdenacio[] ordenar;
    ...
    public PerfilCriteria(
           ...
           es.caib.rolsac.api.v2.perfil.PerfilOrdenacio[] ordenar) {
        super(
            id,
            idioma,
            inici,
    ...
    /**
     * Gets the ordenar value for this PerfilCriteria.
     * 
     * @return ordenar
     */
    public es.caib.rolsac.api.v2.perfil.PerfilOrdenacio[] getOrdenar() {
        return ordenar;
    }


    /**
     * Sets the ordenar value for this PerfilCriteria.
     * 
     * @param ordenar
     */
    public void setOrdenar(es.caib.rolsac.api.v2.perfil.PerfilOrdenacio[] ordenar) {
        this.ordenar = ordenar;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://perfil.v2.api.rolsac.caib.es", "PerfilOrdenacio"));
        elemField.setNillable(true);
