...
public class DocumentTramitCriteria  extends es.caib.rolsac.api.v2.general.BasicCriteria  implements java.io.Serializable {
    ...
    private es.caib.rolsac.api.v2.documentTramit.DocumentTramitOrdenacio[] ordenar;
    ...
    public DocumentTramitCriteria(
           ...
           es.caib.rolsac.api.v2.documentTramit.DocumentTramitOrdenacio[] ordenar) {
        super(
            id,
            idioma,
            inici,
    ...
    /**
     * Gets the ordenar value for this DocumentTramitCriteria.
     * 
     * @return ordenar
     */
    public es.caib.rolsac.api.v2.documentTramit.DocumentTramitOrdenacio[] getOrdenar() {
        return ordenar;
    }


    /**
     * Sets the ordenar value for this DocumentTramitCriteria.
     * 
     * @param ordenar
     */
    public void setOrdenar(es.caib.rolsac.api.v2.documentTramit.DocumentTramitOrdenacio[] ordenar) {
        this.ordenar = ordenar;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://documentTramit.v2.api.rolsac.caib.es", "DocumentTramitOrdenacio"));
        elemField.setNillable(true);
