/**
 * ExcepcioDocumentacioWSSoapBindingStub.java
 *
...
public class ExcepcioDocumentacioWSSoapBindingStub extends org.apache.axis.client.Stub implements es.caib.rolsac.api.v2.excepcioDocumentacio.ws.ExcepcioDocumentacioQueryServiceEJBRemote {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getNumDocumentsTramit");
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getNumDocumentsTramitReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("llistarDocumentsTramits");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://ws.excepcioDocumentacio.v2.api.rolsac.caib.es", "ArrayOf_xsd_anyType"));
        oper.setReturnClass(java.lang.Object[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "llistarDocumentsTramitsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getNumCatalegsDocuments");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        oper.setReturnClass(int.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getNumCatalegsDocumentsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("llistarCatalegsDocuments");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://catalegDocuments.v2.api.rolsac.caib.es", "CatalegDocumentsCriteria"), es.caib.rolsac.api.v2.catalegDocuments.CatalegDocumentsCriteria.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://ws.excepcioDocumentacio.v2.api.rolsac.caib.es", "ArrayOf_xsd_anyType"));
        oper.setReturnClass(java.lang.Object[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "llistarCatalegsDocumentsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[3] = oper;
    ...
    public ExcepcioDocumentacioWSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ExcepcioDocumentacioWSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ExcepcioDocumentacioWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cachedSerQNames.add(qName);
            cls = es.caib.rolsac.api.v2.excepcioDocumentacio.ExcepcioDocumentacioCriteria.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://excepcioDocumentacio.v2.api.rolsac.caib.es", "ExcepcioDocumentacioDTO");
            cachedSerQNames.add(qName);
            cls = es.caib.rolsac.api.v2.excepcioDocumentacio.ExcepcioDocumentacioDTO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://ws.excepcioDocumentacio.v2.api.rolsac.caib.es", "ArrayOf_xsd_anyType");
            cachedSerQNames.add(qName);
    ...
    public int getNumDocumentsTramit(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.excepcioDocumentacio.v2.api.rolsac.caib.es", "getNumDocumentsTramit"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public java.lang.Object[] llistarDocumentsTramits(long in0, es.caib.rolsac.api.v2.documentTramit.DocumentTramitCriteria in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.excepcioDocumentacio.v2.api.rolsac.caib.es", "llistarDocumentsTramits"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0), in1});
  ...
  throw axisFaultException;
    ...
    public int getNumCatalegsDocuments(long in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.excepcioDocumentacio.v2.api.rolsac.caib.es", "getNumCatalegsDocuments"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(in0)});
  ...
  throw axisFaultException;
    ...
    public java.lang.Object[] llistarCatalegsDocuments(long in0, es.caib.rolsac.api.v2.catalegDocuments.CatalegDocumentsCriteria in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://intf.ejb.excepcioDocumentacio.v2.api.rolsac.caib.es", "llistarCatalegsDocuments"));
