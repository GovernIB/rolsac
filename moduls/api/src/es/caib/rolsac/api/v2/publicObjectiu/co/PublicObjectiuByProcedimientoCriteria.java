...
public class PublicObjectiuByProcedimientoCriteria extends ByLongCriteria {

    public PublicObjectiuByProcedimientoCriteria(String field) {
        super(field);
    }
    ...
    public void extendCriteria(QueryBuilder qb) {
        StringBuilder query = new StringBuilder(" SELECT p_.publicosObjetivo.elements ")
                .append("FROM ProcedimientoLocal AS p_ ")
                .append("WHERE p_.id ");
