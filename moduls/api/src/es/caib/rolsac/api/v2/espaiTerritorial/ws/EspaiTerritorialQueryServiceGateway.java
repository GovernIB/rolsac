...
public class EspaiTerritorialQueryServiceGateway {
	...
	public List<EspaiTerritorialDTO> llistarFills(long id,
		...
		// La definici� d'aquest m�tode al wsdl es diferent a la gen�rica
		// per tal d'evitar un ArrayStoreException. Per aix� no cal fer el
		// pas de conversi� des de "Object" a "xxxDTO" com a la resta de
		// m�todes "llistarXxx"
