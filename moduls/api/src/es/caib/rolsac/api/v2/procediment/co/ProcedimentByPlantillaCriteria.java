...
public class ProcedimentByPlantillaCriteria extends ByLongCriteria {

	public ProcedimentByPlantillaCriteria(final String field) {
		super(field);
	}
	...
	public void extendCriteria(final QueryBuilder qb) {
		...
		final StringBuilder query = new StringBuilder(" SELECT tram_.procedimiento ").append("FROM Tramite AS tram_ ")
				.append("WHERE tram_.plantilla.id ");
