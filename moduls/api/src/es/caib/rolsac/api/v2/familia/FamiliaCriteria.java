...
public class FamiliaCriteria  extends es.caib.rolsac.api.v2.general.BasicCriteria  implements java.io.Serializable {
    private java.lang.String t_nombre;

    private java.lang.String t_descripcion;

    private es.caib.rolsac.api.v2.familia.FamiliaOrdenacio[] ordenar;

    public FamiliaCriteria() {
    }
    ...
    public FamiliaCriteria(
           ...
           es.caib.rolsac.api.v2.familia.FamiliaOrdenacio[] ordenar) {
        super(
            id,
            idioma,
            inici,
    ...
    /**
     * Gets the t_nombre value for this FamiliaCriteria.
     * 
     * @return t_nombre
     */
    ...
    /**
     * Sets the t_nombre value for this FamiliaCriteria.
     * 
     * @param t_nombre
     */
    ...
    /**
     * Gets the t_descripcion value for this FamiliaCriteria.
     * 
    ...
    /**
     * Sets the t_descripcion value for this FamiliaCriteria.
     * 
     * @param t_descripcion
     */
    ...
    /**
     * Gets the ordenar value for this FamiliaCriteria.
     * 
     * @return ordenar
     */
    public es.caib.rolsac.api.v2.familia.FamiliaOrdenacio[] getOrdenar() {
        return ordenar;
    }


    /**
     * Sets the ordenar value for this FamiliaCriteria.
     * 
     * @param ordenar
     */
    public void setOrdenar(es.caib.rolsac.api.v2.familia.FamiliaOrdenacio[] ordenar) {
        this.ordenar = ordenar;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FamiliaCriteria)) return false;
        FamiliaCriteria other = (FamiliaCriteria) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FamiliaCriteria.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://familia.v2.api.rolsac.caib.es", "FamiliaCriteria"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://familia.v2.api.rolsac.caib.es", "FamiliaOrdenacio"));
        elemField.setNillable(true);
