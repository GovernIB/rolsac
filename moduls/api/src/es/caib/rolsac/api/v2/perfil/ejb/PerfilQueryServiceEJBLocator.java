...
public class PerfilQueryServiceEJBLocator extends EJBLocator {
    ...
    public PerfilQueryServiceEJBRemote getPerfilQueryServiceEJB() throws LocatorException {
        try {
            ...
            PerfilQueryServiceEJBHome home = (PerfilQueryServiceEJBHome) PortableRemoteObject.narrow(ref, PerfilQueryServiceEJBHome.class);
            return (PerfilQueryServiceEJBRemote) PortableRemoteObject.narrow(home.create(), PerfilQueryServiceEJBRemote.class);
