...
public interface RolsacQueryServiceStrategy {
	...
	CatalegDocumentsDTO obtenirCatalegDocuments(CatalegDocumentsCriteria catalegDocumentsCriteria)
			throws StrategyException;

	List<CatalegDocumentsDTO> llistarCatalegsDocuments(CatalegDocumentsCriteria catalegDocumentsCriteria)
			throws StrategyException;
	...
	List<DocumentoNormativaDTO> llistarDocumentoNormativa(DocumentoNormativaCriteria documentoNormativaCriteria)
			throws StrategyException;

	List<DocumentoServicioDTO> llistarDocumentoServicio(DocumentoServicioCriteria documentoServicioCriteria)
			throws StrategyException;
	...
	ExcepcioDocumentacioDTO obtenirExcepcioDocumentacio(ExcepcioDocumentacioCriteria excepcioDocumentacioCriteria)
			throws StrategyException;

	List<ExcepcioDocumentacioDTO> llistarExcepcionsDocumentacio(
	...
	List<UnitatAdministrativaDTO> llistarUnitatsAdministratives(
