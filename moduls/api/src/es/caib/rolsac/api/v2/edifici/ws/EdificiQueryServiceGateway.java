...
public class EdificiQueryServiceGateway {
    ...
    public ArxiuDTO obtenirFotoPequenya(Long idFotoPequenya) throws RemoteException {
    ...
    public List<UnitatAdministrativaDTO> llistarUnitatsAdministratives(long id,
            UnitatAdministrativaCriteria unitatAdministrativaCriteria) throws RemoteException {
        ...
        llistaMateries = new ArrayList<UnitatAdministrativaDTO>( Arrays.asList(tmpLlista).size() );
