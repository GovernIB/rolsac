...
<!--
    ...
    // Funci�n para abrir la lista de opciones para busqueda o relacion
    ...
    // Funci�n para abrir el popup de afectaciones
    ...
    function busquedaNoRelacionadas(){
        ...
        document.location = "<html:rewrite page='/contenido/normativa/local/seleccionar.do'/>?action=" + accion;
    }

    function mostrarNormativa(id){
        accion = '<bean:message key='boton.seleccionar' />';
        document.location = "<html:rewrite page='/contenido/normativa/local/editar.do'/>?action=" + accion + "&idSelect="+ id;
    }
    ...
    <logic:present name="normativaForm" property="id">
        function asignarAfectacion(tafectacion, normativa2){
            ...
            document.location = "<html:rewrite page='/contenido/normativa/local/editar.do'/>?action=" + accion + "&normativa1=" + normativa1 + "&normativa2=" + normativa2 + "&tafectacion=" + tafectacion + "&operacion=alta";
        }

        function asignarOpcion(id){
            accion = '<bean:message key="normativa.relacion.procedimiento" />';
            idNormativa = '<bean:write name="normativaForm" property="id" />';
            document.location = "<html:rewrite page='/contenido/normativa/local/editar.do'/>?action=" + accion + "&normativa=" + idNormativa + "&procedimiento=" + id + "&operacion=alta";
        }
...
<div class="bloc">
    <h1>
        <logic:notPresent name="normativaForm" property="id">
                <bean:message key="normativa.local.alta" />
        </logic:notPresent>
        <logic:present name="normativaForm" property="id">
                <bean:message key="normativa.local.modificacion" />
        </logic:present>
    </h1>
...
<html:form action="/contenido/normativa/local/editar" styleId="normativaForm" enctype="multipart/form-data">
    ...
    <div class="bloc">
        ...
        <div class="component">
			...
			<html:text styleClass="ctext" property="valorRegistro" maxlength="256" tabindex="6" />
		</div>
        <div class="component">
			<div class="etiqueta"><bean:message key="normativa.ley" /></div>
			<html:text styleClass="btext" property="ley" maxlength="256" tabindex="7" />
		</div>
        <div class="component">
			<div class="etiqueta"><bean:message key="normativa.fecha" /></div>
			<html:text styleClass="ctext" property="textoFecha" maxlength="15" tabindex="8" />
            <div class="botoneraconsulta1">
                <html:button property="boton" onclick="abrirCalendario('textoFecha')" tabindex="9"><bean:message key="boton.seleccionar" /></html:button>
            </div>
		</div>
        <div class="component">
			<div class="etiqueta"><bean:message key="normativa.fechaBoletin" /></div>
			<html:text styleClass="ctext" property="textoFechaBoletin" maxlength="15" tabindex="10" />
            <div class="botoneraconsulta1">
        ...
        <div id="capa<%=i%>" class="capa">
            ...
            <div class="bloc">
                <div class="component">
                    ...
                    <html:text styleClass="btext" name="traducciones" property="titulo" indexed="true" tabindex="12"  maxlength="256" />
                </div>
                <div class="component">
                    <div class="etiqueta"><bean:message key="normativa.enlace" /></div>
                    <html:text styleClass="btext" name="traducciones" property="enlace" indexed="true" tabindex="13"  maxlength="512" />
                </div>
                <div class="component">
    ...
    <div class="bloc">
        ...
        <logic:notEmpty name="afectacionOptions">
            ...
            <div class="component">
                ...
                <div class="botoneraconsulta1">
                    <html:form action="/contenido/normativa/local/editar" >
