...
<!--
    ...
    // Funci�n para abrir la lista de edificios para relaci�n
    ...
    // Funci�n para abrir la lista de materias para relaci�n
    function listaMaterias(){
        obrir("<html:rewrite page='/organigrama/unidad/popmateria.do'/>", "<bean:message key='boton.seleccionar' />", 538, 140);
    }

    // Funci�n para abrir la lista de usuarios para relaci�n
