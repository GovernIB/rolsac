...
<bean:define id="inicial" name="idEspacio" type="java.lang.Long" />
<html:html locale="true" xhtml="true">
<!-- (PORMAD) -->
<head>
   <title>SAC Arbol - EspacioTerritorial</title>
   ...
   <!--
        ...
        function carregar(id, nombre, acceso){
            if (!acceso){
                alert("<bean:message key='espacio.error.acceso' />");
            } else {
                opener.actualizaEspacio(id, nombre);
                window.close();
            }
        }
        </logic:present>
        ...
        <logic:notEmpty name="raizOptions">
            ...
            <logic:notPresent name="ficha">
                ex.push(new init_ex(1,"","- <bean:message key='espacio.raiz' /> -",false,"0"),true);
            </logic:notPresent>
            <%
                String carpeta = "true";
                String access = "false";
            ...
            <logic:iterate id="raiz" name="raizOptions" indexId="idx" >
                ...
                %>
                    ...
                    <logic:notEmpty name="<%=actual.toString()%>">
                        <tiles:insert page="/sistema/espacio/hijos.jsp" flush="false" >
...
<body>
	<div id="organigrama">
		<div id="capsalera">
            ...
            <logic:notPresent name="ficha">
                <h1><bean:message key="espacio.padre.titulo" /></h1>
            </logic:notPresent>
        </div>
        <div id="llistat">
        <logic:notEmpty name="raizOptions">
            ...
            <html:form action="/sistema/espacio/arbol" styleId="padreForm">
                <input type="hidden" name="action" value='<bean:message key="boton.expandir" />' />
                <input type="hidden" name="idEspacio" value="<%=inicial%>" />
                <logic:present name="ficha">
        ...
        <logic:empty name="raizOptions">
            <center>
            <bean:message key="espacio.vacio" />
            </center>
        </logic:empty>
        </div>
