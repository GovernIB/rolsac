...
<!--
    ...
    function validar(form) {
       return validateTiniciacionForm(form);
    }
// -->
</script>
<script type="text/javascript">
...
<div class="bloc">
    <h1>
        <logic:notPresent name="tiniciacionForm" property="id">
            <bean:message key="tiniciacion.alta" />
        </logic:notPresent>
        <logic:present name="tiniciacionForm" property="id">
            <bean:message key="tiniciacion.modificacion" />
        </logic:present>
    </h1>
    <h2>
        <bean:message key="tiniciacion.datos" />
    </h2>
</div>
...
<html:form action="/sistema/tiniciacion/editar" styleId="tiniciacionForm">
    <logic:present name="tiniciacionForm" property="id">
    ...
    <div class="bloc">
         <div class="component">
        	<div class="etiqueta"><bean:message key="tiniciacion.codiestandar" /></div>
            <html:text styleClass="btext" property="codigoEstandar" maxlength="256" tabindex="2" />
        </div>
    </div>
    <br/>
    <div id="capes">
    <bean:size id="capes" name="tiniciacionForm" property="traducciones"/>
    <logic:iterate id="traducciones" name="tiniciacionForm" property="traducciones" indexId="i" >
        <div id="capa<%=i%>" class="capa">
            ...
            <div class="bloc">
                <div class="component">
                    <div class="etiqueta"><bean:message key="tiniciacion.nombre" /></div>
