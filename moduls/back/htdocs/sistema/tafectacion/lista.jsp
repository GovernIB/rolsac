...
<div class="bloc">
    ...
    <h2><bean:message key="tafectacion.datos" /></h2>
</div>
<br />

<logic:empty name="tipoOptions">
    <div class="bloc">
        <br /><h2><bean:message key="tafectacion.vacio" /></h2><br />
    </div>
</logic:empty>
        ...
        <logic:iterate id="tipo" name="tipoOptions">
            <div class="component">
                ...
                <div class="botoneraconsulta1">
                    <html:form action="/sistema/tafectacion/seleccionar" styleId="tafectacionForm">
...
<br />
<center>
[<html:link page="/sistema/tafectacion/form.do" ><bean:message key="boton.nuevo" /></html:link>]
</center>
