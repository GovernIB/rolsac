...
<!--
    ...
    function validar(form) {
       return validateTafectacionForm(form);
    }
// -->
</script>
<script type="text/javascript">
...
<div class="bloc">
    <h1>
        <logic:notPresent name="tafectacionForm" property="id">
            <bean:message key="tafectacion.alta" />
        </logic:notPresent>
        <logic:present name="tafectacionForm" property="id">
            <bean:message key="tafectacion.modificacion" />
        </logic:present>
    </h1>
    <h2>
        <bean:message key="tafectacion.datos" />
    </h2>
</div>
...
<html:form action="/sistema/tafectacion/editar" styleId="tafectacionForm">
    <logic:present name="tafectacionForm" property="id">
        <html:hidden property="id" />
    </logic:present>

    <div id="capes">
    <bean:size id="capes" name="tafectacionForm" property="traducciones"/>
    <logic:iterate id="traducciones" name="tafectacionForm" property="traducciones" indexId="i" >
        <div id="capa<%=i%>" class="capa">
            ...
            <div class="bloc">
                <div class="component">
                    <div class="etiqueta"><bean:message key="tafectacion.nombre" /></div>
