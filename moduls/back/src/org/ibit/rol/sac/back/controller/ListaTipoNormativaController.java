...
/**
 * Controller para obtener una lista de Tipo Normativa
 */
public class ListaTipoNormativaController implements Controller {
    public void perform(ComponentContext componentContext, HttpServletRequest request,
        ...
        try {
            ...
            request.setAttribute("tipoOptions", delegate.listarTiposNormativas());
