...
public class GuardarProcedimientoAction extends BaseAction {

	protected static Log log = LogFactory.getLog(GuardarProcedimientoAction.class);

	  
	protected ActionForward guardar(EditarProcedimientoAction action, ActionParameters params) throws DelegateException, Exception {
