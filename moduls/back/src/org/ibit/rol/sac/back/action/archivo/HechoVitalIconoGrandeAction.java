...
/**
 * @struts.action
 *  path="/hechovital/icono/grande"
 *  scope="request"
 *  validate="false"
 *  Action que obtiene el icono grande de un hecho vital (PORMAD)
 */
public class HechoVitalIconoGrandeAction extends ArchivoAction{
      public Archivo obtenerArchivo(ActionMapping mapping,
        ...
        return hechoDelegate.obtenerIconoGrande(idHecho);
    }
}
