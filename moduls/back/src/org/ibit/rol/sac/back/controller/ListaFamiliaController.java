...
/**
 * Controller para generar una lista de Familias
 */
public class ListaFamiliaController implements Controller{
    ...
    public void perform(ComponentContext componentContext, HttpServletRequest request,
        ...
        try {
            ...
            request.setAttribute("familiaOptions", delegate.listarFamilias());
