...
public class ALTASERVICIO  extends org.ibit.rol.sac.persistence.ws.sia.consultar.v3_0.paramSIA.TRAMITE  implements java.io.Serializable {
    public ALTASERVICIO() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.map.es/sgca/consultar/messages/v3_0/ParamSIA", "ALTASERVICIO"));
    }
