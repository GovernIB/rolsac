...
public class EDICIONDOCUMENTACIONASOCIADA  implements java.io.Serializable {
    ...
    private org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.ALTADOCUMENTOSESPECIFICOSALTADOCUMENTOESPECIFICO[] ALTADOCUMENTOSESPECIFICOS;

    private org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.DOCUMENTOSCATALOGODOCUMENTOCATALOGO[] DOCUMENTOSCATALOGO;
    ...
    public EDICIONDOCUMENTACIONASOCIADA(
           ...
           org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.ALTADOCUMENTOSESPECIFICOSALTADOCUMENTOESPECIFICO[] ALTADOCUMENTOSESPECIFICOS,
           org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.DOCUMENTOSCATALOGODOCUMENTOCATALOGO[] DOCUMENTOSCATALOGO) {
     ...
     */
    public org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.ALTADOCUMENTOSESPECIFICOSALTADOCUMENTOESPECIFICO[] getALTADOCUMENTOSESPECIFICOS() {
        return ALTADOCUMENTOSESPECIFICOS;
    }
     ...
     */
    public void setALTADOCUMENTOSESPECIFICOS(org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.ALTADOCUMENTOSESPECIFICOSALTADOCUMENTOESPECIFICO[] ALTADOCUMENTOSESPECIFICOS) {
        this.ALTADOCUMENTOSESPECIFICOS = ALTADOCUMENTOSESPECIFICOS;
    }
     ...
     */
    public org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.DOCUMENTOSCATALOGODOCUMENTOCATALOGO[] getDOCUMENTOSCATALOGO() {
        return DOCUMENTOSCATALOGO;
    }
     ...
     */
    public void setDOCUMENTOSCATALOGO(org.ibit.rol.sac.persistence.ws.sia.actualizar.v3_0.paramSIA.DOCUMENTOSCATALOGODOCUMENTOCATALOGO[] DOCUMENTOSCATALOGO) {
        this.DOCUMENTOSCATALOGO = DOCUMENTOSCATALOGO;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "EDICIONDOCUMENTACIONASOCIADA"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("NOREQUIEREDOCUMENTACION");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "NOREQUIEREDOCUMENTACION"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "DOCUMENTACION"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "ALTADOCUMENTOSESPECIFICOS"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", ">ALTADOCUMENTOSESPECIFICOS>ALTADOCUMENTOESPECIFICO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "ALTADOCUMENTOESPECIFICO"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("DOCUMENTOSCATALOGO");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "DOCUMENTOSCATALOGO"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", ">DOCUMENTOSCATALOGO>DOCUMENTOCATALOGO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.map.es/sgca/actualizar/messages/v3_0/ParamSIA", "DOCUMENTOCATALOGO"));
        typeDesc.addFieldDesc(elemField);
    }
