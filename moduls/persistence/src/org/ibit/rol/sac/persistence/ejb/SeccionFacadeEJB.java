...
public abstract class SeccionFacadeEJB extends HibernateEJB {
    ...
    /**
     * WEBCAIB Colección ordenada de padres ( de root a codi, incluido ) retorna TemaModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    ...
    /**
     * WEBCAIB Colección de hijos de una sección/tema. retorna TemaModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    ...
    /**
     * WEBCAIB Colección de temas principales (raices). retorna TemaModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la sección indicada. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Collection getLinks(Long codi, int inicial, int tamany, String idioma, int valida) {
        ...
        try {
            ...
            Query query = session.createQuery("select fua " + "from FichaUA as fua "
                    + "inner join fetch fua.ficha as f " + "where fua.seccion.id = :seccion_id "
                    + "and ( f.fechaCaducidad is null or f.fechaCaducidad >= :fecha ) "
                    + "and f.validacion = :validacion " + "order by fua.orden asc, f.fechaActualizacion desc");
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la sección indicada dentro del rango de orden.
     * retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la sección indicada dentro del rango de orden y la
     * UO. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Collection getLinksByOrderRangeAndUO(Long codi, int ordre_i, int ordre_f, String coduo, String idioma,
            int valida) {
        ...
        try {
            ...
            Query query = session.createQuery("select fua " + "from FichaUA as fua "
                    ...
                    + "and fua.orden between :ordre_i and :ordre_f "
                    + "and ( f.fechaCaducidad is null or f.fechaCaducidad >= :fecha ) "
                    + "and f.validacion = :validacion " + "and fua.unidadAdministrativa = :coduo "
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la sección indicada y la UO. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Collection getLinksByUO(Long codi, Long coduo, int inicial, int tamany, String idioma, int valida) {
        ...
        try {
            ...
            Query query = session.createQuery("select fua " + "from FichaUA as fua "
                    ...
                    + "and f.validacion = :validacion " + "and ( fua.unidadAdministrativa = :coduo or 0 = :coduo ) "
                    + "order by fua.orden asc, f.fechaActualizacion desc");
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la sección indicada y la materia. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Collection getLinksByMat(Long codi, Long codmat, int inicial, int tamany, String idioma, int valida) {
        ...
        try {
            ...
            String q = "select distinct ficha " + "from Ficha as ficha, ficha.materias as mat, ficha.fichasua as fua "
            ...
            q += "and ( ficha.fechaCaducidad is null or ficha.fechaCaducidad >= :fecha ) "
                    ...
                    + "and ficha.validacion = :validacion " + "order by ficha.fechaActualizacion desc";
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que pertenecen a la materia indicada. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Collection getLinksByMat(Long codmat, int inicial, int tamany, String idioma, int valida, Date fultenv) {
        ...
        try {
            ...
            String q = "select distinct ficha " + "from Ficha as ficha, ficha.materias as mat "
                    + "where mat.id=:id_materia "
                    + "and ( ficha.fechaPublicacion is null or ficha.fechaPublicacion < :fecha ) "
                    + "and ( ficha.fechaCaducidad is null or ficha.fechaCaducidad >= :fecha ) " +

                    "and ( " + "trunc(coalesce(ficha.fechaPublicacion, :fecha_minima)) <= trunc(sysdate) "
    ...
    /**
     * WEBCAIB Devuelve una colección de LinkModel que tienen foro y pertenecen a la sección indicada y la materia.
     * retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
    ...
    public Collection getLinksByMatForo(Long codi, Long codmat, int inicial, int tamany, String idioma, int valida) {
        ...
        try {
            ...
            String q = "select distinct ficha " + "from Ficha as ficha, ficha.materias as mat, ficha.fichasua as fua "
                    + "where mat.id=:id_materia " + "and fua.seccion=:id_seccion "
                    + "and ( ficha.fechaCaducidad is null or ficha.fechaCaducidad >= :fecha ) "
                    + "and ( ficha.fechaPublicacion is null or ficha.fechaPublicacion < :fecha ) "
                    + "and ficha.validacion = :validacion " + "and ficha.urlForo is not null "
    ...
    /**
     * WEBCAIB Devuelve un LinkModel. retorna LinkModel
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public LinkModel getLink(Long codi, String idioma, int valida, String previ) {
        ...
        try {
            ...
            Query query = session.createQuery("select fua " + "from FichaUA as fua "
                    + "inner join fetch fua.ficha as f " + "where f.id = :id_ficha "
    ...
    /**
     * WEBCAIB Devuelve el número de fichas de la sección especificada.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Integer getNumLinks(Long codi) {
        ...
        try {
            ...
            Query query = session.createQuery("select count(fua) " + "from FichaUA as fua "
                    + "inner join fua.ficha as f " + "where fua.seccion = :id_seccion " + "and f.validacion = 1 ");
    ...
    /**
     * WEBCAIB Devuelve el número de fichas de la sección especificada y unidad administrativa.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    ...
    /**
     * WEBCAIB Devuelve el número de fichas de la sección especificada y materia.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public Integer getNumLinksByMat(Long codi, String materia) {
        ...
        try {
            ...
            Query query = session.createQuery("select count(fua) " + "from FichaUA as fua "
                    + "inner join fua.ficha as f " + "inner join f.materias as mat "
    ...
    /**
     * WEBCAIB Devuelve la fecha de auditoria de la ficha especificada.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     */
    public String getData(Long codiFitxa) {
        ...
        try {
            String data = "";
            Query query = session.createQuery("select aud.fecha " + "from Auditoria as aud, HistoricoFicha his "
                    + "where aud.historico = his.id " + "and his.ficha = :id_ficha " + "order by aud.fecha desc ");
    ...
    /**
     * WEBCAIB Pasa los datos de Ficha (hibernate) a LinkModel (WEBCAIB) obteniendo datos adicionales.
     * 
     * @param ficha
     *            Ficha.
     * @param linkModel
    ...
    private void pasarFichaALinkModel(Ficha ficha, LinkModel linkModel, String idioma, String idUO) {
        ...
        if (linkModel.getNom() == null || linkModel.getDescabr() == null || linkModel.getDesc() == null
                || linkModel.getUrl() == null)
