  ...
  /**
    ...
    public ActuacioModel getActuacio ( String code, String idioma, String previ ) {
        ...
        try {
    		...
    		//List<Tramite> listaTramites = (List)proc.getTramites(); //as� no salen todos...
    		...
    		for (Tramite tramite : listaTramites) {
    			...
    			*/
    			...
    			//Documentos informativos del tr�mite
	...
	/** 
	 * WEBCAIB
	 * Retorna una informaci� de totes les actuacions que estan relacionades amb la 
	 * fitxa especificada, en l'idioma especificat
	 *
	 * @param codiFitxa codi de la fitxa que interessa
	 * @param idioma en el que volem la informaci�.
	 * 
	 * @return col.lecci� de ActuacioMinModel amb informaci� reduida de les actuacions
	 * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true" 
	 */
	...
	/** 
	 * WEBCAIB
	 * Retorna una informaci� de totes les actuacions mes cercades 
	 * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true" 
	 */
	...
	/** 
	 * WEBCAIB
	 * Realiza una b�squeda avanzada en procedimientos.
	 * 
	 * Este m�todo se ha copiado directamente del proyecto WEBCAIB durante la migraci�n de m�todos de este proyecto a ROLSAC.
	 * No ha sido posible su implementaci�n en Hibernate debido a que hace uso de las instrucciones start with connect by de ORACLE.
	 * Adem�s recibe en el par�metro condi condiciones where en lenguaje SQL que no entiende HQL y ser�a bastante costoso traducir de forma
	 * din�mica.
	 * 
	 * @return col.lecci� de ActuacioMinModel amb informaci� reduida de les actuacions
	 * 
	...
	public Collection actuacionsByAvanzado ( String condi, String idioma, String uo, String solovigor, String idisel ) {
	    ...
	    try {    	
			...
			"rsc_trapro, " +
			"rsc_trauna ";
			//solo si hemos filtrado por tema, a�adimos la tabla  
			...
			//CANVI u102068 Aplicar recursivitat de nivells en la cerca per unitat org�nica
	...
	/**
	 * WEBCAIB
	 * Retorna el n�mero de actuaciones que tiene la uo.<br/>
	 * 
	 * @param codiUO, int c�digo de unidad org�nica
	 * @param idioma, String en el que volem la informaci�.

	 * @return int, n�mero de actuaciones que tiene la uo.
	 *
     * @ejb.interface-method
     * @ejb.permission unchecked="true" 
	 */	
	...
	/**
	 * WEBCAIB
	 * Retorna una informaci� de totes les actuacions d'una familia determinada 
	 * ordenada per data publicaci�.
	 * 
	 * Este m�todo se ha copiado directamente del proyecto WEBCAIB durante la migraci�n de m�todos de este proyecto a ROLSAC.
	 * No ha sido posible su implementaci�n en Hibernate debido a que existe un bug en Hibernate 2 con la instrucci�n group by. En resumen
	...
	/**
	 * WEBCAIB
	 * Retorna una informaci� de totes les actuacions d'una familia  i unitat org�nica determinada 
	 * ordenada per data publicaci�.
	 * 
	 * Este m�todo se ha copiado directamente del proyecto WEBCAIB durante la migraci�n de m�todos de este proyecto a ROLSAC.
	 * No ha sido posible su implementaci�n en Hibernate debido a que existe un bug en Hibernate 2 con la instrucci�n group by. En resumen
	...
	/**
	 * WEBCAIB
	 * Retorna una informaci� de totes les actuacions d'una familia i mat�ria determinada 
	 * ordenada per data publicaci�.
	 * 
	 * Este m�todo se ha copiado directamente del proyecto WEBCAIB durante la migraci�n de m�todos de este proyecto a ROLSAC.
	 * No ha sido posible su implementaci�n en Hibernate debido a que existe un bug en Hibernate 2 con la instrucci�n group by. En resumen
	...
	/**
	 * M�todo de apoyo para transformar datos de la entidad ProcedimientoLocal a la entidad WEBCAIB ActuacioMinModel.
	...
	//M�todo adaptado de WEBCAIB para actuacionsByAvanzado, actuacionsByFamilia, actuacionsByFamiliaUO, actuacionsByFamiliaMat.
	...
	//M�todo copiado de WEBCAIB para actuacionsByAvanzado.
    /**
