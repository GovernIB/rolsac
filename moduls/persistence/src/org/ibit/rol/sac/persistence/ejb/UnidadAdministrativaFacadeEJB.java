...
//  CODI NOU PELS LOGOS
   ...
   */
    ...
    /**
     * WEBCAIB.
     * Obtiene el c�digo perteneciente al Govern.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     * 
    ...
    /**
     * WEBCAIB.
     * Devuelve una lista de los centros de una unidad administrativa a partir de su c�digo.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true" 
     */	
    ...
    /**
     * WEBCAIB.
     * Obtiene la lista de unidades administrativas el c�digo de materia indicado
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true"
     * 
	...
	public Collection getUoByMateria( String pare, String materia, String idioma ) {
		...
		try {
			...
			//Obtenemos primero la lista de unidades en el idioma por defecto por c�digo y materia
    ...
    /**
     * WEBCAIB.
     * Obtiene informaci�n de c�digo, nombre y tipo de las unidades org�nicas dependientes
     * de la que se pasa por par�metro en el idioma especificado.
     * 
     * @ejb.interface-method
     * @ejb.permission unchecked="true" 
     */	
	...
	public UOModel getDetails(String codi, String idioma) {
		...
		try {
			...
			//Campos de traducci�n unidad administrativa
			...
			//Campos de traducci�n tratamiento
