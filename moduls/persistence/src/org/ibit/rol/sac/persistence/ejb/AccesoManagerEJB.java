 ...
 *
 * @ejb.bean
 *  name="sac/persistence/AccesoManager"
 *  jndi-name="org.ibit.rol.sac.persistence.AccesoManager"
 *  type="Stateless"
 *  view-type="local"
...
public abstract class AccesoManagerEJB extends HibernateEJB {
    ...
    /**
     * Devuelve <code>true</code> si y solo si el usuario puede acceder a la unidad administrativa.
     * El par?metro modificar inidica si el acceso ?s solo a efectos de publicar contenido relacionado
     * o a modificar los datos de la unidad.
    ...
    public boolean tieneAccesoUnidad(Long idUA, boolean modificar) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (UnidadAdministrativa) session.get(UnidadAdministrativa.class, idUA),
                    modificar);
    ...
    /**
     * Devuelve <code>true</code> si y solo si el usuario puede mover una unidad administrativa
     * desde una unidad padre actual a otra nueva unidad padre.
     * @ejb.interface-method
    ...
    public boolean tieneAccesoMoverOrganigrama(final Long oldParent, final Long newParent) {
        ...
        try {
    		...
    		final UnidadAdministrativa oldUA = (UnidadAdministrativa) session.get(UnidadAdministrativa.class, oldParent);
    		final UnidadAdministrativa newUA = (UnidadAdministrativa) session.get(UnidadAdministrativa.class, newParent);        	
    ...
    public boolean tieneAccesoSeccion(Long idSec) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Seccion) session.get(Seccion.class, idSec));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoProcedimiento(Long idProc) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (ProcedimientoLocal) session.get(ProcedimientoLocal.class, idProc));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoNormativa(Long idNorma) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Normativa) session.get(Normativa.class, idNorma));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoFicha(Long idFicha) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Ficha) session.get(Ficha.class, idFicha));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoFichaUnidad(Long idFichaUA) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (FichaUA) session.get(FichaUA.class, idFichaUA));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoDocumento(Long idDoc) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Documento) session.get(Documento.class, idDoc));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoTramite(Long idTram) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Tramite) session.get(Tramite.class, idTram));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoFormulario(Long idForm) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Formulario) session.get(Formulario.class, idForm));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoEdificio(Long idEdi) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Edificio) session.get(Edificio.class, idEdi));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
    ...
    public boolean tieneAccesoPersonal(Long idPers) {
        ...
        try {
            return tieneAcceso(
                    getUsuario(session),
                    (Personal) session.get(Personal.class, idPers));
        } catch (HibernateException he) {
            throw new EJBException(he);
        } finally {
            close(session);
