...
public abstract class IndexerFacadeEJB extends HibernateEJB {
    ...
    /**
     * Busca documentos para un idioma concreto, con opci�n de sugerir
    ...
    private Directory getHibernateDirectory(String idi) throws IOException {
        ...
        if (FILESYSTEM_INDEX_TYPE.equals(indexType)) {
            ...
            throw new EJBException("Tipo de �ndice no valido: " + indexType);
        }
	...
	/* Clase que sobreescribe un m�todo de QueryParser para permitir hacer sugerencias 
	 * cuando las b�squedas sean compuestas
	 * 
	 */ 
