 ...
 */
            ...
            /**
            *  ConsultarDetalleTramite bean class
            */
        
        public  class ConsultarDetalleTramite
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = consultarDetalleTramite
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localIdTramite ;
                           ...
                           */
                           public  java.lang.String getIdTramite(){
                            ...
                            /**
                               ...
                               */
                               public void setIdTramite(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localIdTramiteTracker = true;
                                       } else {
                                          localIdTramiteTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ConsultarDetalleTramite.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":consultarDetalleTramite",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"idTramite", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"idTramite");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("idTramite");
                                    }
                                

                                          if (localIdTramite==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localIdTramite);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLocalizacion));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://webservice.service.si.vuds.map.es/",
                                        ...
                                        if (localIdTramite != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIdTramite));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("idTramite cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static ConsultarDetalleTramite parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConsultarDetalleTramite object =
                new ConsultarDetalleTramite();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"consultarDetalleTramite".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConsultarDetalleTramite)es.map.vuds.si.service.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservice.service.si.vuds.map.es/","idTramite").equals(reader.getName())){
