 ...
 */
            ...
            /**
            *  GuardarTramites bean class
            */
        
        public  class GuardarTramites
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = guardarTramites
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  es.map.vuds.si.service.webservice.Tramite[] getTramite(){
                              ...
                              /**
                               * validate the array for Tramite
                               */
                             ...
                             */
                             public void addTramite(es.map.vuds.si.service.webservice.Tramite param){
                                   if (localTramite == null){
                                   localTramite = new es.map.vuds.si.service.webservice.Tramite[]{};
                                   }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GuardarTramites.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":guardarTramites",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "guardarTramites",
    ...
    public static class Factory{
        ...
        */
        public static GuardarTramites parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GuardarTramites object =
                new GuardarTramites();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"guardarTramites".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GuardarTramites)es.map.vuds.si.service.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(es.map.vuds.si.service.webservice.Tramite.Factory.parse(reader));
                                                        ...
                                                        object.setTramite((es.map.vuds.si.service.webservice.Tramite[])
