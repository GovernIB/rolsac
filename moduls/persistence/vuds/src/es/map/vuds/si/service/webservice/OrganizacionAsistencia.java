 ...
 */
            ...
            /**
            *  OrganizacionAsistencia bean class
            */
        
        public  class OrganizacionAsistencia
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = organizacionAsistencia
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for DescripcionOrganizacionAsistencia
                        */

                        
                                    protected java.lang.String localDescripcionOrganizacionAsistencia ;
                           ...
                           */
                           public  java.lang.String getDescripcionOrganizacionAsistencia(){
                               return localDescripcionOrganizacionAsistencia;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DescripcionOrganizacionAsistencia
                               */
                               public void setDescripcionOrganizacionAsistencia(java.lang.String param){
                            
                                            this.localDescripcionOrganizacionAsistencia=param;
                        ...
                        */
                                    ...
                                    protected java.lang.String localOrganismo ;
                           ...
                           */
                           public  java.lang.String getOrganismo(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Organismo
                               */
                               public void setOrganismo(java.lang.String param){
                            
                                            this.localOrganismo=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       OrganizacionAsistencia.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":organizacionAsistencia",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "organizacionAsistencia",
                           xmlWriter);
                   }
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"descripcionOrganizacionAsistencia", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"descripcionOrganizacionAsistencia");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("descripcionOrganizacionAsistencia");
                                    }
                                

                                          if (localDescripcionOrganizacionAsistencia==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("descripcionOrganizacionAsistencia cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localDescripcionOrganizacionAsistencia);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"organismo", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"organismo");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("organismo");
                                    }
                                

                                          if (localOrganismo==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("organismo cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localOrganismo);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localAmbito);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                                                      "descripcionOrganizacionAsistencia"));
                                 
                                        if (localDescripcionOrganizacionAsistencia != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDescripcionOrganizacionAsistencia));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("descripcionOrganizacionAsistencia cannot be null!!");
                                        }
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localOrganismo != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrganismo));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("organismo cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static OrganizacionAsistencia parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OrganizacionAsistencia object =
                new OrganizacionAsistencia();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"organizacionAsistencia".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OrganizacionAsistencia)es.map.vuds.si.service.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","descripcionOrganizacionAsistencia").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setDescripcionOrganizacionAsistencia(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","organismo").equals(reader.getName())){
