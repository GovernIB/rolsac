...
public class CatalegServeisBackController extends PantallaBaseController {
	...
	public @ResponseBody Map<String, Object> llistatNormatives(HttpServletRequest request, HttpSession session) {
		...
		List<ServicioNormativaDTO>llistaNormativesDTO= new ArrayList<ServicioNormativaDTO>();
		Map<String,Object> resultats = new HashMap<String,Object>();
		...
		try {
			...
			for (Normativa normativa : castList(Normativa.class, resultadoBusqueda.getListaResultados()) ) {
				...
				llistaNormativesDTO.add( new ServicioNormativaDTO( idNormativa, tituloEnlaceHTML, fecha, fechaBoletin ) );
			}
