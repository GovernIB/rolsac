...
//					Missatge.llansar({tipus: "alerta", modo: "correcte", fundit: "si", titol: data.nom});
	...
	this.nou = function() {
        ...
        //#356 tras pulsar el bot�n volver se pone el modulo con el class a invisible, como pintarModulos necesita dades
...
//        this.pintarModulos(miObjeto);
		...
		limpiarArchivo("item_foto_petita");
		limpiarArchivo("item_foto_gran");
		limpiarArchivo("item_planol");
