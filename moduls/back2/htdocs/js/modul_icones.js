...
function CModulIcones() {
	...
	this.torna = function() {
		...
		escriptori_icones_elm.fadeOut(300, function() {
			...
			// Los iconos del m�dulo de familias y el de materias utilizan "modul_icones.js" pero 
			// los la gesti�n de cambios de pantalla es distinta. Para que funcione en los dos 
			// casos debemos a�adir esta l�nea
	...
	this.guarda_upload = function() {
        ...
        // XXX amartin IMPORTANTE: aquí se agregarían más casos si este módulo se añade a otros mantenimientos.
