...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			codi_cap1 = "<div class=\"th publicObjectiu" + ordre_c1 + "\" role=\"columnheader\">" + txtLlistaItem + "</div>";
		...
		dades_elm.fadeOut(300, function() {
			...
			dades_elm.html(codi_final).fadeIn(300, function() {
				...
				escriptori_contingut_elm.find("#resultats .llistat .tbody a.editarPublicObjectiu").unbind("click").bind("click",function(){Llistat.ficha(this);});
