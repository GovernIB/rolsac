...
$(document).ready(function() {
	...
	CAMPOS_TRADUCTOR_SILENCIO = ["item_descripcio_","item_nombre_"];
	DATOS_TRADUCIDOS_SILENCIO = ["descripcion", "nombre"];
...
//        });        
        ...
        jQuery("#item_nombre,#item_nombre_es,#item_nombre_en,#item_nombre_de,#item_nombre_fr").change(function(){
            jQuery("#item_item_nombre,#item_item_nombre_es,#item_item_nombre_en,#item_item_nombre_de,#item_item_nombre_fr").val( jQuery(this).val() );
        });
        ...
        // boton de traducir
        jQuery("#botoTraduirSilenciAdm").unbind("click").bind("click", function() {
	...
	this.traduirWrapper = function () {
		that.traduir(pagTraduirsilenciAdm, CAMPOS_TRADUCTOR_SILENCIO, DATOS_TRADUCIDOS_SILENCIO);
	}
