...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			codi_cap1 = "<div class=\"th butlleti" + ordre_c1 + "\" role=\"columnheader\">" + txtLlistaItem + "</div>";
			...
			$(data.nodes).slice(resultatInici-1,resultatFinal).each(function(i) {
				...
				codi_taula += "<div class=\"td butlleti\" role=\"gridcell\">";
				codi_taula += "<input type=\"hidden\" value=\"" + dada_node.id + "\" class=\"id\" />";
				codi_taula += "<a id=\"butlleti_"+dada_node.id+"\" href=\"javascript:;\" class=\"butlleti\">" + printStringFromNull(dada_node.nom, txtSinValor) + "</a>";
				codi_taula += "</div>";				
				codi_taula += "<div class=\"td enllas\" role=\"gridcell\">" + printStringFromNull(dada_node.enllas, txtSinValor) + "</div>";
...
function CDetall(){
	...
	this.pintar = function(dades) {
		...
		$("#item_enllas").val(dada_node.item_enllas);
