		...
		if (resultats_total > 0) {
			...
			$(data.nodes).each(function(i) {
				...
				if (dada_node.tipo == "PRO") {
					...
					txtSiaDescripcionTipo = txtSiaDescripcionTipoProDoc + " " + dada_node.idElemento;
				}else if(dada_node.tipo == "NOR "){
					txtSiaDescripcionTipo = txtSiaDescripcionTipoNor + " " + dada_node.idElemento;
				}else if(dada_node.tipo == "DNO"){
					txtSiaDescripcionTipo = txtSiaDescripcionTipoNorDoc + " " + dada_node.idElemento;
				}else if(dada_node.tipo == "TRA"){
					txtSiaDescripcionTipo = txtSiaDescripcionTipoTra + " " + dada_node.idElemento;
				}else if(dada_node.tipo == "DFC "){
					txtSiaDescripcionTipo = txtSiaDescripcionTipoFichaDoc + " " + dada_node.idElemento;
				}else {
					txtSiaDescripcionTipo = txtSiaDescripcionTipoFicha+ " "+ dada_node.idElemento ;
				}
