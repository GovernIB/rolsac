...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			$(data.nodes).each(function(i) {
				...
				codi_taula += "<div class=\"td tipusUnitat\" role=\"gridcell\">";
				codi_taula += "<input type=\"hidden\" value=\"" + dada_node.id + "\" class=\"id\" />";
				codi_taula += "<a id=\"tipusUnitat_"+dada_node.id+"\" href=\"javascript:;\" class=\"nom\">" + printStringFromNull(dada_node.tipus, txtSinValor) + "</a>";
				codi_taula += "</div>";				
...
function CDetall(){
	...
	this.pintar = function(dades) {
		...
		for (var i in idiomas) {
			...
			$("#item_tipus_" + idioma).val(printStringFromNull(dada_node[idioma]["tipo"]));
			$("#item_carreg_femeni_" + idioma).val(printStringFromNull(dada_node[idioma]["cargoF"]));
			$("#item_carreg_masculi_" + idioma).val(printStringFromNull(dada_node[idioma]["cargoM"]));
			$("#item_tractament_femeni_" + idioma).val(printStringFromNull(dada_node[idioma]["tratamientoF"]));
			$("#item_tractament_masculi_" + idioma).val(printStringFromNull(dada_node[idioma]["tratamientoM"]));
		}
