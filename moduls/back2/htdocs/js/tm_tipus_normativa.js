...
$(document).ready(function() {
	...
	CAMPOS_TRADUCTOR_TIPUS_NORMATIVA = ["item_nom_"];
	DATOS_TRADUCIDOS_TIPUS_NORMATIVA = ["nombre"];
...
function CDetall(){
	...
	this.iniciar = function() {	
		...
		// boton de traducir
        jQuery("#botoTraduirTipusNormativa").unbind("click").bind("click", function() {
	...
	this.traduirWrapper = function () {
		that.traduir(pagTraduirTipusNormativa, CAMPOS_TRADUCTOR_TIPUS_NORMATIVA, DATOS_TRADUCIDOS_TIPUS_NORMATIVA);
	}
