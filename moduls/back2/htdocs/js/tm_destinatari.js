...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			codi_cap1 = "<div class=\"th destinatari" + ordre_c1 + "\" role=\"columnheader\">" + txtLlistaItem + "</div>";
			...
			$(data.nodes).each(function(i) {				
				...
				codi_taula += "<div class=\"td destinatari\" role=\"gridcell\">";
				codi_taula += "<input type=\"hidden\" value=\"" + dada_node.id + "\" class=\"id\" />";
				codi_taula += "<a id=\"destinatari_"+dada_node.id+"\" href=\"javascript:;\" class=\"destinatari\">" + printStringFromNull(dada_node.nom, txtSinValor) + "</a>";
				codi_taula += "</div>";				
...
function CDetall(){
	...
	this.pintar = function(dades) {
		...
		$("#item_id_remot").val(dada_node.item_id_remot);
