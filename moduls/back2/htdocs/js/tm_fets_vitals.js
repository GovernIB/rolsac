...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
		...
		dades_elm.fadeOut(300, function() {
			...
			dades_elm.html(codi_final).fadeIn(300, function() {
				...
				jQuery("#resultats .llistat .tbody a.pujarFetsVitals").unbind("click").bind("click",function(){
...
//					Missatge.llansar({tipus: "alerta", modo: "correcte", fundit: "si", titol: data.nom});
	...
	this.pintar = function(dades) {
		...
		if (dada_node["item_icona_gran_enllas_arxiu"]) {
			...
			var a = $("#grup_item_icona_gran a");
			a.attr("href", pagArrel + dada_node["item_icona_gran_enllas_arxiu"]);
			a.text(dada_node["item_icona_gran"]);
