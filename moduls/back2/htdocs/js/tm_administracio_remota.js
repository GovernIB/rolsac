...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			codi_cap1 = "<div class=\"th administracioRemota" + ordre_c1 + "\" role=\"columnheader\">" + txtLlistaItem + "</div>";
			codi_cap2 = "<div class=\"th enllas" + ordre_c2 + "\" role=\"columnheader\">" + txtEnllas + "</div>";
			...
			$(data.nodes).slice(resultatInici-1,resultatFinal).each(function(i) {
				...
				codi_taula += "<div class=\"td administracioRemota\" role=\"gridcell\">";
				codi_taula += "<input type=\"hidden\" value=\"" + dada_node.id + "\" class=\"id\" />";
				codi_taula += "<a id=\"administracioRemota_"+dada_node.id+"\" href=\"javascript:;\" class=\"administracioRemota\">" + printStringFromNull(dada_node.nom, txtSinValor) + "</a>";
				codi_taula += "</div>";				
				codi_taula += "<div class=\"td enllas\" role=\"gridcell\">" + printStringFromNull(dada_node.idRemoto, txtSinValor) + "</div>";
...
//					Missatge.llansar({tipus: "alerta", modo: "correcte", fundit: "si", titol: data.nom});
	...
	this.pintar = function(dades) {
		...
		$("#item_idRemot").val(dada_node.item_idRemot);
		$("#item_responsable").val(dada_node.item_responsable);
		$("#item_versio_ws").val(dada_node.item_versio_ws);
