...
$(document).ready(function() {
	...
	CAMPOS_TRADUCTOR_TIPUS_INICIACIO = ["item_nom_"];
	DATOS_TRADUCIDOS_TIPUS_INICIACIO = ["nombre"];
...
// 			codi_cap1 = "<div class=\"th nom" + ordre_c1 + "\" role=\"columnheader\"><a href=\"javascript:;\">" + txtLlistaItem + "</a></div>";
			...
			$(data.nodes).each(function(i) {
				...
				codi_taula += "<div class=\"td tipusIniciacio\" role=\"gridcell\">";
				codi_taula += "<input type=\"hidden\" value=\"" + dada_node.id + "\" class=\"id\" />";
				codi_taula += "<a id=\"tipusIniciacio_"+dada_node.id+"\" href=\"javascript:;\" class=\"nom\">" + printStringFromNull(dada_node.nom, txtSinValor) + "</a>";
				codi_taula += "</div>";				
...
function CDetall(){
	...
	this.iniciar = function() {	
        ...
        // boton de traducir
        jQuery("#botoTraduirTipusIniciacio").unbind("click").bind("click", function() {
	...
	this.traduirWrapper = function () {
		that.traduir(pagTraduirTipusIniciacio, CAMPOS_TRADUCTOR_TIPUS_INICIACIO, DATOS_TRADUCIDOS_TIPUS_INICIACIO);
	}
