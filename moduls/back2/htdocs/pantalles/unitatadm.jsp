...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
	...
	<div id="escriptori_detall">
		<form id="guardarUnitatAdministrativa" action="false">
		...
		<div class="botonera dalt">
			<ul>
				...
				<li>
					<a href="javascript:;" class="btn previsualitza"><span><span>Previsualitza</span></span></a>
				</li>
			</ul>
		</div>
		-->
								...
								<div class="idioma ca">	
									...
									<div class="fila">
										<div class="element t99p">
											...
											<div class="control">
												<textarea id="item_presentacio_ca" name="item_presentacio_ca" rows="6" class="rich complexe nou"></textarea>
											</div>
										</div>
									</div>	
									<div class="fila">
								...
								<div class="idioma es">
									...
									<div class="fila">
										<div class="element t99p">
											...
											<div class="control">
												<textarea id="item_presentacio_es" name="item_presentacio_es" cols="70" rows="6" class="rich complexe nou"></textarea>
											</div>
										</div>
									</div>
									<div class="fila">
								...
								<div class="idioma en">
									...
									<div class="fila">
										<div class="element t99p">
											...
											<div class="control">
												<textarea id="item_presentacio_en" name="item_presentacio_en" cols="70" rows="6" class="rich complexe nou"></textarea>
											</div>
										</div>
									</div>
									<div class="fila">
								...
								<div class="idioma de">
									...
									<div class="fila">
										<div class="element t99p">
											...
											<div class="control">
												<textarea id="item_presentacio_de" name="item_presentacio_de" cols="70" rows="6" class="rich complexe nou"></textarea>
											</div>
										</div>
									</div>
									<div class="fila">
								...
								<div class="idioma fr">
									...
									<div class="fila">
										<div class="element t99p">
											...
											<div class="control">
												<textarea id="item_presentacio_fr" name="item_presentacio_fr" cols="70" rows="6" class="rich complexe nou"></textarea>
											</div>
										</div>
									</div>	
									<div class="fila">
            ...
            <div class="resultats C actiu" style="display: block;">
                <div id="cercador" class="escriptori_items_cercador"> 
                    <div id="cercador_contingut">
		                ...
		                <div class="botonera">
                            <div class="boton btnGenerico"><a class="btn borrar" href="javascript:;"><span><span>Borrar</span></span></a></div>
                            <div class="boton btnGenerico"><a class="btn consulta" href="javascript:;"><span><span>Cercar</span></span></a></div>
                            <div class="boton btnGenerico"><a class="btn torna" href="javascript:;"><span><span>Torna al detall</span></span></a></div>             
                        </div>
