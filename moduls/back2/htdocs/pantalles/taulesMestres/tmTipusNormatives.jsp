...
<link href='<c:url value="/css/tm_tipus_normatives.css"/>' rel="stylesheet" type="text/css" media="screen" />

<script type="text/javascript" src="<c:url value='/js/tm_tipus_normativa.js'/>"></script>
<script type="text/javascript">
    var pagLlistat = '<c:url value="/tipusNormatives/llistat.do" />';
    var pagDetall = '<c:url value="/tipusNormatives/pagDetall.do" />';
    var pagGuardar = '<c:url value="/tipusNormatives/guardar.do" />';
    var pagEsborrar = '<c:url value="/tipusNormatives/esborrarTipusNormativa.do" />';
    var pagTraduirTipusNormativa = '<c:url value="/tipusNormatives/traduir.do" />';
    ...
    var txtLlistaItem = "<spring:message code='txt.tipus_normativa'/>";
    var txtLlistaItems = "<spring:message code='txt.tipus_normatives'/>";
    ...
    var FormulariDades = [
        {
            ...
            "error":
                {
                    "obligatori": "<spring:message code='tipusNormativa.formulari.nom.obligatori'/>",
                    "tipus": "<spring:message code='tipusNormativa.formulari.nom.no_nomes_numeros'/>"
                }
        }
    ];
</script>
    ...
    <ul id="opcions">
        ...
        <li class="opcions nuevo">
            <a id="btnNuevaFicha" href="javascript:;" class="btn nou">
                <span><span><spring:message code='tipusNormativa.crea_nou_tipus_normativa'/></span></span>
            </a>
        </li>
    </ul>   
    <div id="resultats">
        <div class="resultats L actiu">                         
            <div class="dades">             
                <p class="executant"><spring:message code='tipusNormativa.carregant_llistat_tipusNormativa'/></p>                           
            </div>                          
                        ...
                        <div class="fila">
                            <p class="introIdiomas"><spring:message code='txt.idioma.idioma'/>:</p>
                                <ul class="idiomes">
                                    ...
                                    <li class="traduix btnGenerico" id="botoTraduirTipusNormativa">
