...
<script type="text/javascript">
    ...
    var txtLlistaItem = "<spring:message code='camp.tipo.procedimiento'/>";
    var txtLlistaItems = "<spring:message code='txt.tipus.procediments'/>";
                        ...
                        <div class="modulIcones">                            
                            <div class="seleccionats">
	                            ...
	                            <div class="btnGenerico">
	                                ...
	                                <a id="btnGuardar_modul_icones" href="javascript:;" class="btn guarda important lista-simple-iconos" style="display: none"
