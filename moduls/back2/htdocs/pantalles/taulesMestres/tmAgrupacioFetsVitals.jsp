                                ...
                                <div class="idioma <c:out value="${lang}"/>">
                                    ...
                                    <div class="fila">                              
                                        <div class="element t99p">
                                            <div class="etiqueta">
                                                <label for="item_nom_<c:out value="${lang}"/>"><spring:message code='agrupacioFV.formulari.nom'/></label>
                                            </div>
                                            <div class="control">                           
                                    ...
                                    <div class="fila">
                                        <div class="element t99p">
                                            <div class="etiqueta">
                                                <label for="item_descripcio_<c:out value="${lang}"/>"><spring:message code='agrupacioFV.formulari.descripcio'/></label>
                                            </div>
                                            <div class="control">
                                                <textarea id="item_descripcio_<c:out value="${lang}"/>" name="item_descripcio_<c:out value="${lang}"/>" cols="50" rows="3" class="nou"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fila">
                                        <div class="element t99p">
                                            <div class="etiqueta">
                                                <label for="item_paraules_clau_<c:out value="${lang}"/>"><spring:message code='agrupacioFV.formulari.paraules_clau'/></label>
                                            </div>
                                            <div class="control">
                                                <textarea id="item_paraules_clau_<c:out value="${lang}"/>" name="item_paraules_clau_<c:out value="${lang}"/>" cols="50" rows="3" class="nou"></textarea>
                                            </div>
                                        </div>
                                    </div>
