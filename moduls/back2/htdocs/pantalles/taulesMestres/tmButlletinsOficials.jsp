...
<link href='<c:url value="/css/tm_butlletins.css"/>' rel="stylesheet" type="text/css" media="screen" />

<script type="text/javascript" src="<c:url value='/js/tm_butlleti.js'/>"></script>
<script type="text/javascript">
    var pagLlistat = '<c:url value="/butlletinsOficials/llistat.do" />';
    var pagDetall = '<c:url value="/butlletinsOficials/pagDetall.do" />';
    var pagGuardar = '<c:url value="/butlletinsOficials/guardar.do" />';
    var pagEsborrar = '<c:url value="/butlletinsOficials/esborrarButlleti.do" />';
    ...
    var txtLlistaItem = "<spring:message code='txt.butlleti'/>";
    var txtLlistaItems = "<spring:message code='txt.butlletins'/>";
    ...
    var FormulariDades = [
        {
            ...
            "error":
                {
                    "obligatori": "<spring:message code='butlleti.formulari.nom.obligatori'/>",
                    "tipus": "<spring:message code='butlleti.formulari.nom.no_nomes_numeros'/>"
                }
        },
        {
            "modo": "individual",
            "etiqueta": "id",
            "etiquetaValor": "item_enllas",
            "obligatori": "no",
            "caracters":
                {
                    "maxim": 490,
    ...
    <ul id="opcions">
        ...
        <li class="opcions nuevo">
            <a id="btnNuevaFicha" href="javascript:;" class="btn nou">
                <span><span><spring:message code='butlleti.crea_nou_butlleti'/></span></span>
            </a>
        </li>
    </ul>   
    <div id="resultats">
        <div class="resultats L actiu">                         
            <div class="dades">             
                <p class="executant"><spring:message code='butlleti.carregant_llistat_butlleti'/></p>                           
            </div>                          
