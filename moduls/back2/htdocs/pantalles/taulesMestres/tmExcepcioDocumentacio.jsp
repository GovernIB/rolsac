...
<link href='<c:url value="/css/tm_excepcio_documentacio.css"/>' rel="stylesheet" type="text/css" media="screen" />

<script type="text/javascript" src="<c:url value='/js/tm_excepcio_documentacio.js'/>"></script>
<script type="text/javascript">
    var pagLlistat = '<c:url value="/excepcioDocumentacio/llistat.do" />';
    var pagDetall = '<c:url value="/excepcioDocumentacio/pagDetall.do" />';
    var pagGuardar = '<c:url value="/excepcioDocumentacio/guardar.do" />';
    var pagEsborrar = '<c:url value="/excepcioDocumentacio/esborrarExcepcioDocumentacio.do" />';
    var pagTraduirExcepcioDocumentacio = '<c:url value="/excepcioDocumentacio/traduir.do" />';
    ...
    var txtLlistaItem = "<spring:message code='txt.excepcio_documentacio'/>";
    var txtLlistaItems = "<spring:message code='txt.excepcions_documentacio'/>";
    ...
    var FormulariDades = [
        {
            ...
            "error":
                {
                    "obligatori": "<spring:message code='excdoc.formulari.nom.obligatori'/>",
                    "tipus": "<spring:message code='excdoc.formulari.nom.no_nomes_numeros'/>"
                }
        }
    ];
</script>
    ...
    <ul id="opcions">
        ...
        <li class="opcions nuevo">
            <a id="btnNuevaFicha" href="javascript:;" class="btn nou">
                <span><span><spring:message code='excdoc.crea_nova_excepcio_documentacio'/></span></span>
            </a>
        </li>
    </ul>   
    <div id="resultats">
        <div class="resultats L actiu">                         
            <div class="dades">             
                <p class="executant"><spring:message code='excdoc.carregant_llistat_excepcio_documentacio'/></p>                           
            </div>                          
                        ...
                        <div class="fila">
                            <p class="introIdiomas"><spring:message code='txt.idioma.idioma'/>:</p>
                                <ul class="idiomes">
                                    ...
                                    <li class="traduix btnGenerico" id="botoTraduirExcepcioDocumentacio">
                            ...
                            <div class="idiomes">
                                ...
                                <div class="idioma <c:out value="${lang}"/>">
                                    ...
                                    <div class="fila">
                                        <div class="element t99p">
                                            <div class="etiqueta">
                                                <label for="item_descri_<c:out value="${lang}"/>"><spring:message code='camp.descripcio'/></label>
                                            </div>
                                            <div class="control">
                                            	<textarea id="item_descri_<c:out value="${lang}"/>" name="item_descri_<c:out value="${lang}"/>" cols="70" rows="3" class="nou"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
