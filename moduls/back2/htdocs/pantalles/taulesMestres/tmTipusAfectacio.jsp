...
<link href='<c:url value="/css/tm_tipus_afectacions.css"/>' rel="stylesheet" type="text/css" media="screen" />

<script type="text/javascript" src="<c:url value='/js/tm_tipus_afectacio.js'/>"></script>
<script type="text/javascript">
    var pagLlistat = '<c:url value="/tipusAfectacio/llistat.do" />';
    var pagDetall = '<c:url value="/tipusAfectacio/pagDetall.do" />';
    var pagGuardar = '<c:url value="/tipusAfectacio/guardar.do" />';
    var pagEsborrar = '<c:url value="/tipusAfectacio/esborrarTipusAfectacio.do" />';
    var pagTraduirTipusAfectacio = '<c:url value="/tipusAfectacio/traduir.do" />';
    ...
    var txtLlistaItem = "<spring:message code='txt.tipus_afectacio'/>";
    var txtLlistaItems = "<spring:message code='txt.tipus_afectacions'/>";
    ...
    var FormulariDades = [
        {
            ...
            "error":
                {
                    "obligatori": "<spring:message code='tipusAfectacio.formulari.nom.obligatori'/>",
                    "tipus": "<spring:message code='tipusAfectacio.formulari.nom.no_nomes_numeros'/>"
                }
        }
    ];
</script>
    ...
    <ul id="opcions">
        ...
        <li class="opcions nuevo">
            <a id="btnNuevaFicha" href="javascript:;" class="btn nou">
                <span><span><spring:message code='tipusAfectacio.crea_nou_tipus_afectacio'/></span></span>
            </a>
        </li>
    </ul>   
    <div id="resultats">
        <div class="resultats L actiu">                         
            <div class="dades">             
                <p class="executant"><spring:message code='tipusAfectacio.carregant_llistat_tipusAfectacio'/></p>                           
            </div>                          
                        ...
                        <div class="fila">
                            <p class="introIdiomas"><spring:message code='txt.idioma.idioma'/>:</p>
                                <ul class="idiomes">
									...
									<li class="traduix btnGenerico" id="botoTraduirTipusAfectacio">
