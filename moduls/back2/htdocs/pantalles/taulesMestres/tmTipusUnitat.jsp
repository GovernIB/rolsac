...
<link href='<c:url value="/css/tm_tipus_unitat.css"/>' rel="stylesheet" type="text/css" media="screen" />

<script type="text/javascript" src="<c:url value='/js/tm_tipus_unitat.js'/>"></script>
<script type="text/javascript">
    var pagLlistat = '<c:url value="/tipusUnitat/llistat.do" />';
    var pagDetall = '<c:url value="/tipusUnitat/pagDetall.do" />';
    var pagGuardar = '<c:url value="/tipusUnitat/guardar.do" />';
    var pagEsborrar = '<c:url value="/tipusUnitat/esborrarTipusUnitat.do" />';
    var pagTraduirTipusUA = '<c:url value="/tipusUnitat/traduir.do" />';
    ...
    var txtLlistaItem = "<spring:message code='txt.tipus_unitat'/>";
    var txtLlistaItems = "<spring:message code='txt.tipus_unitats'/>";
    ...
    var FormulariDades = [
        {
            ...
            "error":
                {
                    "obligatori": "<spring:message code='tipusUnitat.formulari.tipus.obligatori'/>",
                    "tipus": "<spring:message code='tipusUnitat.formulari.tipus.no_nomes_numeros'/>"
                }
        },
        {
            "modo": "individual",
    ...
    <ul id="opcions">
        ...
        <li class="opcions nuevo">
            <a id="btnNuevaFicha" href="javascript:;" class="btn nou">
                <span><span><spring:message code='tipusUnitat.crea_nou_tipus_unitat'/></span></span>
            </a>
        </li>
    </ul>   
    <div id="resultats">
        <div class="resultats L actiu">                         
            <div class="dades">             
                <p class="executant"><spring:message code='tipusUnitat.carregant_llistat_tipus_unitat'/></p>                           
            </div>                          
                            ...
                            <p class="introIdiomas"><spring:message code='txt.idioma.idioma'/>:</p>
                                <ul class="idiomes">
                                    ...
                                    <c:if test="${traductorActivo}">
	                                    <li class="traduix btnGenerico" id="botoTraduirTipusUA">
