    ...
    var FormulariDades = [
        {
            ...
            "modo": "individual",
            "etiqueta": "id",
            "etiquetaValor": "item_descripcio_" + '<c:out value="${idiomaVal}"/>',
            "obligatori": "si",
            "tipus": "alfanumeric",
            "caracters":
                {
                            ...
                            <p class="introIdiomas"><spring:message code='txt.idioma.idioma'/>:</p>
                                <ul class="idiomes">
								    ...
								    <c:if test="${traductorActivo}">
									    <li class="traduix btnGenerico" id="botoTraduirEdifici">
                                ...
                                <div class="idioma <c:out value="${lang}"/>">
                                    <div class="fila">                              
                                        <div class="element t99p">
                                            <div class="etiqueta">
                                                <label for="item_descripcio_<c:out value="${lang}"/>"><spring:message code='edifici.formulari.descripcio'/></label>
                                            </div>
                                            <div class="control">                           
                                                <input id="item_descripcio_<c:out value="${lang}"/>" name="item_descripcio_<c:out value="${lang}"/>" type="text" class="nou" />
                                            </div>                                      
                                        </div>                      
                                    </div>
