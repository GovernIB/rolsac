...
public class BinaryBlobType implements UserType {
	...
	protected static final Log log = LogFactory.getLog(BinaryBlobType.class);
	...
	private Blob createAndRegisterTemporalBlob(
		...
		log.debug("[nullSafeSet] obrint i escribint en BLOB temporal");
		...
		blob.close();
		log.debug("[nullSafeSet] tancant BLOB temporal");
