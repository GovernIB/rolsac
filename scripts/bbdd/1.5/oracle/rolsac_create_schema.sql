...
alter table RSC_TRANOR drop constraint FKB70E4B0B7BADA044;
...
alter table RSC_TRANOR add constraint FKB70E4B0B7BADA044 foreign key (TNO_CODARC) references RSC_ARCHIV;
