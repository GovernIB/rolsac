...
create table RSC_TRADNR (
   ...
   TDN_TITULO varchar(512),
   TDN_DESCRI varchar(4000),
   TDN_ENLACE varchar(512),
   TDN_CODARC int8,
   TDN_CODIDI varchar(2) not null,
   primary key (TDN_CODDNR, TDN_CODIDI)
);
create table RSC_TRAMPL (
   TPA_CODI int8 not null,
   TPA_IDENTI varchar(256),
   TPA_VERSION varchar(3),
   TPA_PARAMS text,
   TPA_FASE int4,
   TPA_CODPLT int8,
...
create table RSC_TRATPA (
   TTP_CODPLT int8 not null,
   TTP_NOMBRE varchar(256),
   TTP_CODIDI varchar(2) not null,
