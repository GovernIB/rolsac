...
create table RSC_SIAPDT  (
  ...
  ALTER TABLE RSC_TRAFIC ADD TFI_URLFOR character varying(256);
  ALTER TABLE RSC_TRAFIC ADD TFI_URLVID character varying(256);
  ALTER TABLE RSC_TRAFIC ADD TFI_ICONO integer;
  ALTER TABLE RSC_TRAFIC ADD TFI_IMAGEN integer;
  ALTER TABLE RSC_TRAFIC ADD TFI_BANNER integer;
