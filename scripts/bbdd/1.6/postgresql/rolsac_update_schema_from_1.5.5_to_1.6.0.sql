...
ALTER TABLE RSC_NORMAT ADD NOR_TYPEN VARCHAR2(64 CHAR);
ALTER TABLE RSC_NORMAT ADD NOR_VALIDN NUMBER(10, 0);
ALTER TABLE RSC_NORMAT ADD NOR_CODBOL_ANT NUMBER(19, 0);
ALTER TABLE RSC_NORMAT ADD NOR_NUMNOR VARCHAR2(10 CHAR);
ALTER TABLE RSC_NORMAT MODIFY (NOR_TYPE NULL);
ALTER TABLE RSC_NORMAT ADD NOR_DATVAL NUMBER(1,0);
